...
wandb.init(project='CycleStain_Ver.3_0206 & aialpha_PNG',
           config=HPARAMS,
           # consistency, TV, content, adversarial
           name='Trial 7_02->AIAlpha_1000ep: 1/0/0/1/2 - G_lr: 1e^-6 D_lr: 1e^-6_step20,0.9_256x256',
#            mode='disabled',
           notes=NOTES)
...
#     print(np.max(data[0]))
    ...
    '''
    model = CycleGAN_NewLoss.CycleGAN(HPARAMS)
    ...
    train_input = datasets.ImageFolder(root='/data/JS/JS_dataset/CycleGAN/Pretrain_GenA/0206_R_1ch/Phase/02_R_300x300_1ch', transform=transformer)
    ...
    test_input = datasets.ImageFolder(root='/data/JS/JS_dataset/CycleGAN/Pretrain_GenA/Val_ground/Phase', transform=transformer)
