...
class CycleGAN(nn.Module):
    def __init__(self, CONFIG, test=False):
        ...
        self.model_G_x2y.load_state_dict(torch.load(PATH + 'Pretrain_XtoY/PNG/Glr0.001_Dlr0.0001_GenXtoY_of_CycleStain_Ramp_02_1ch_NIR_png_256x256_1000epoch.pt'))
        self.model_G_y2x.load_state_dict(torch.load(PATH + 'Pretrain_YtoX/PNG/Glr0.001_Dlr0.0001_GenYtoX_of_CycleStain_Ramp_02_1ch_NIR_png_256x256_2000epoch.pt'))
        
        self.model_D_x.load_state_dict(torch.load(PATH + 'Pretrain_YtoX/PNG/Glr0.001_Dlr0.0001_DisX_of_CycleStain_Ramp_02_1ch_NIR_png_256x256_2000epoch.pt'))
        self.model_D_y.load_state_dict(torch.load(PATH + 'Pretrain_XtoY/PNG/Glr0.001_Dlr0.0001_DisY_of_CycleStain_Ramp_02_1ch_NIR_png_256x256_1000epoch.pt'))
