...
#             self.main = nn.Conv2d(in_channels=self.i_c, out_channels=self.o_c, kernel_size=32, stride=1, padding=0)
            #500x500
#             self.main = nn.Conv2d(in_channels=self.i_c, out_channels=self.o_c, kernel_size=31, stride=1, padding=0)
            # 400x400
#             self.main = nn.Conv2d(in_channels=self.i_c, out_channels=self.o_c, kernel_size=25, stride=1, padding=0)
...
# #     generator = Generator(6,3,3).to(DEVICE)
#     discriminator = Discriminator(3).to(DEVICE)
#     summary(discriminator, input_size=(3, 450, 450))
