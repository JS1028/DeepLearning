...
generator.load_state_dict(torch.load(PATH + 'NIRStain_02_NIR_600x600.pt'))
...
Phase_data = []
RGB_Amp_data = []
contents = glob('/data/FPM_com/tissue NIR dataset/12.bladder_F5_SS14-36841_sec1/NIR/data/mat/*.mat')    
...
for i, content in enumerate(contents):
    if content == '/data/FPM_com/tissue NIR dataset/12.bladder_F5_SS14-36841_sec1/NIR/data/mat/full_results_processed.mat':
            continue
...
#     save_image(phase[0], "/data/JS/Virtual_Staining/Results/08.sto_P_PhaseStain/%.3d_input.png" %(idx+1))
    save_image(data_fake[0], "/data/FPM_com/Virtually Stained tissue dataset/NIRStain/NIR/Train-02_NIR_mat_600x600/12.bladder_F5/Output/%.3d.png" %(idx+1))
#     save_image(phase[0]/torch.max(phase[0]), f"/data/FPM_com/Virtually Stained tissue dataset/PhaseStain/Train-02&06_NIR_mat_600x600/Test_01_toPNG/Input/{idx+1}.png")
